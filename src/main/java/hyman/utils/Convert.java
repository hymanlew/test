...
import hyman.utils2.StringConversUtil;
...
public class Convert {
    ...
    public static Character toChar(Object value, Character defaultValue) {
        if (null == value) {
            ...
            return StringConversUtil.isEmpty(valueStr) ? defaultValue : valueStr.charAt(0);
        }
    }
    ...
    public static Byte toByte(Object value, Byte defaultValue) {
        if (value == null) {
            ...
            String valueStr = toStr(value, (String) null);
            if (StringConversUtil.isEmpty(valueStr)) {
                return defaultValue;
            } else {
                try {
    ...
    public static Integer[] toIntArray(String split, String str) {
        if (StringConversUtil.isEmpty(str)) {
    ...
    public static String str(byte[] bytes, String charset) {
        return str(bytes, StringConversUtil.isEmpty(charset) ? Charset.defaultCharset() : Charset.forName(charset));
    }
